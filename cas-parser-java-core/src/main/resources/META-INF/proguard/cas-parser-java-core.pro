...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.cas_parser.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.cas_parser.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.cas_parser.api.** {
    <init>(...);
