...
class NsdlServiceImpl internal constructor(private val clientOptions: ClientOptions) : NsdlService {
    ...
    override fun withRawResponse(): NsdlService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): NsdlService =
        NsdlServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun parse(params: NsdlParseParams, requestOptions: RequestOptions): UnifiedResponse =
        // post /v4/nsdl/parse
        withRawResponse().parse(params, requestOptions).parse()

    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        NsdlService.WithRawResponse {
        ...
        override fun withOptions(
            ...
            NsdlServiceImpl.WithRawResponseImpl(
