...
interface FetchService {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): FetchService
     ...
     */
    fun requestOtp(params: FetchRequestOtpParams): FetchRequestOtpResponse =
     ...
     */
    fun verifyOtp(sessionId: String, params: FetchVerifyOtpParams): FetchVerifyOtpResponse =
    ...
    /** @see verifyOtp */
    fun verifyOtp(params: FetchVerifyOtpParams): FetchVerifyOtpResponse =
    ...
    /** A view of [FetchService] that provides access to raw HTTP responses for each method. */
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): FetchService.WithRawResponse
         ...
         */
        @MustBeClosed
        fun requestOtp(params: FetchRequestOtpParams): HttpResponseFor<FetchRequestOtpResponse> =
            requestOtp(params, RequestOptions.none())
         ...
         * otherwise the same as [FetchService.verifyOtp].
         */
        @MustBeClosed
        fun verifyOtp(
            sessionId: String,
        ...
        /** @see verifyOtp */
        @MustBeClosed
        fun verifyOtp(params: FetchVerifyOtpParams): HttpResponseFor<FetchVerifyOtpResponse> =
            verifyOtp(params, RequestOptions.none())
