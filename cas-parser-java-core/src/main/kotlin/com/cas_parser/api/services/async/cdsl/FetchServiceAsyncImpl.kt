...
class FetchServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val withRawResponse: FetchServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): FetchServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): FetchServiceAsync =
        FetchServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun requestOtp(
        ...
        // post /v4/cdsl/fetch
        withRawResponse().requestOtp(params, requestOptions).thenApply { it.parse() }
    ...
    override fun verifyOtp(
        ...
        withRawResponse().verifyOtp(params, requestOptions).thenApply { it.parse() }
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            FetchServiceAsyncImpl.WithRawResponseImpl(
