...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SmartParseCasPdfParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SmartParseCasPdfParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(smartParseCasPdfParams: SmartParseCasPdfParams) = apply {
            body = smartParseCasPdfParams.body.toBuilder()
            additionalHeaders = smartParseCasPdfParams.additionalHeaders.toBuilder()
            additionalQueryParams = smartParseCasPdfParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SmartParseCasPdfParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SmartParseCasPdfParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SmartParseCasPdfParams &&
            body == other.body &&
    ...
    override fun toString() =
        "SmartParseCasPdfParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
