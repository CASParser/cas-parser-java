...
class InboundEmailDeleteResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [InboundEmailDeleteResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [InboundEmailDeleteResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(inboundEmailDeleteResponse: InboundEmailDeleteResponse) = apply {
            msg = inboundEmailDeleteResponse.msg
            status = inboundEmailDeleteResponse.status
            additionalProperties = inboundEmailDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InboundEmailDeleteResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): InboundEmailDeleteResponse =
            InboundEmailDeleteResponse(msg, status, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): InboundEmailDeleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InboundEmailDeleteResponse &&
            msg == other.msg &&
            status == other.status &&
    ...
    override fun toString() =
        "InboundEmailDeleteResponse{msg=$msg, status=$status, additionalProperties=$additionalProperties}"
}
