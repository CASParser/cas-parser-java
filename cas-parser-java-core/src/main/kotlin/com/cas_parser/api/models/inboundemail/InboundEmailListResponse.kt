...
private constructor(
    private val inboundEmails: JsonField<List<InboundEmail>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("inbound_emails")
        @ExcludeMissing
        inboundEmails: JsonField<List<InboundEmail>> = JsonMissing.of(),
        @JsonProperty("limit") @ExcludeMissing limit: JsonField<Long> = JsonMissing.of(),
        @JsonProperty("offset") @ExcludeMissing offset: JsonField<Long> = JsonMissing.of(),
        @JsonProperty("status") @ExcludeMissing status: JsonField<String> = JsonMissing.of(),
        @JsonProperty("total") @ExcludeMissing total: JsonField<Long> = JsonMissing.of(),
    ) : this(inboundEmails, limit, offset, status, total, mutableMapOf())

    /**
     * @throws CasParserInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun inboundEmails(): Optional<List<InboundEmail>> = inboundEmails.getOptional("inbound_emails")
    ...
    /**
     * Returns the raw JSON value of [inboundEmails].
     *
     * Unlike [inboundEmails], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("inbound_emails")
    @ExcludeMissing
    fun _inboundEmails(): JsonField<List<InboundEmail>> = inboundEmails
    ...
    /** A builder for [InboundEmailListResponse]. */
    class Builder internal constructor() {

        private var inboundEmails: JsonField<MutableList<InboundEmail>>? = null
        ...
        @JvmSynthetic
        internal fun from(inboundEmailListResponse: InboundEmailListResponse) = apply {
            inboundEmails = inboundEmailListResponse.inboundEmails.map { it.toMutableList() }
            limit = inboundEmailListResponse.limit
            offset = inboundEmailListResponse.offset
            status = inboundEmailListResponse.status
            total = inboundEmailListResponse.total
            additionalProperties = inboundEmailListResponse.additionalProperties.toMutableMap()
        }

        fun inboundEmails(inboundEmails: List<InboundEmail>) =
            inboundEmails(JsonField.of(inboundEmails))

        /**
         * Sets [Builder.inboundEmails] to an arbitrary JSON value.
         *
         * You should usually call [Builder.inboundEmails] with a well-typed `List<InboundEmail>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun inboundEmails(inboundEmails: JsonField<List<InboundEmail>>) = apply {
            this.inboundEmails = inboundEmails.map { it.toMutableList() }
        }

        /**
         * Adds a single [InboundEmail] to [inboundEmails].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addInboundEmail(inboundEmail: InboundEmail) = apply {
            inboundEmails =
                (inboundEmails ?: JsonField.of(mutableListOf())).also {
                    checkKnown("inboundEmails", it).add(inboundEmail)
                }
        }
        ...
        /**
         * Returns an immutable instance of [InboundEmailListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): InboundEmailListResponse =
            InboundEmailListResponse(
                (inboundEmails ?: JsonMissing.of()).map { it.toImmutable() },
                limit,
                offset,
                status,
                total,
    ...
    fun validate(): InboundEmailListResponse = apply {
        ...
        inboundEmails().ifPresent { it.forEach { it.validate() } }
        limit()
        offset()
        status()
        total()
    ...
    internal fun validity(): Int =
        (inboundEmails.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
    ...
    private constructor(
         ...
         *
         * Unlike [inboundEmailId], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("inbound_email_id")
        @ExcludeMissing
        ...
        companion object {
            ...
            /** Returns a mutable builder for constructing an instance of [InboundEmail]. */
            @JvmStatic fun builder() = Builder()
        }

        /** A builder for [InboundEmail]. */
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(inboundEmail: InboundEmail) = apply {
                allowedSources = inboundEmail.allowedSources.map { it.toMutableList() }
                callbackUrl = inboundEmail.callbackUrl
                createdAt = inboundEmail.createdAt
                email = inboundEmail.email
                inboundEmailId = inboundEmail.inboundEmailId
                metadata = inboundEmail.metadata
                reference = inboundEmail.reference
                status = inboundEmail.status
                updatedAt = inboundEmail.updatedAt
                additionalProperties = inboundEmail.additionalProperties.toMutableMap()
            }
            ...
            /** Unique inbound email identifier */
            fun inboundEmailId(inboundEmailId: String) =
                inboundEmailId(JsonField.of(inboundEmailId))
            ...
            /**
             * Returns an immutable instance of [InboundEmail].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): InboundEmail =
                InboundEmail(
        ...
        override fun toString() =
            "InboundEmail{allowedSources=$allowedSources, callbackUrl=$callbackUrl, createdAt=$createdAt, email=$email, inboundEmailId=$inboundEmailId, metadata=$metadata, reference=$reference, status=$status, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InboundEmailListResponse &&
            inboundEmails == other.inboundEmails &&
            limit == other.limit &&
            offset == other.offset &&
            status == other.status &&
            total == other.total &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(inboundEmails, limit, offset, status, total, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "InboundEmailListResponse{inboundEmails=$inboundEmails, limit=$limit, offset=$offset, status=$status, total=$total, additionalProperties=$additionalProperties}"
}
