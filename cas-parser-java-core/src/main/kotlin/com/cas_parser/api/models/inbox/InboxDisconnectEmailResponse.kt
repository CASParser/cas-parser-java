...
class InboxDisconnectEmailResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [InboxDisconnectEmailResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [InboxDisconnectEmailResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(inboxDisconnectEmailResponse: InboxDisconnectEmailResponse) = apply {
            msg = inboxDisconnectEmailResponse.msg
            status = inboxDisconnectEmailResponse.status
            additionalProperties = inboxDisconnectEmailResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InboxDisconnectEmailResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): InboxDisconnectEmailResponse =
            InboxDisconnectEmailResponse(msg, status, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): InboxDisconnectEmailResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InboxDisconnectEmailResponse &&
            msg == other.msg &&
            status == other.status &&
    ...
    override fun toString() =
        "InboxDisconnectEmailResponse{msg=$msg, status=$status, additionalProperties=$additionalProperties}"
}
