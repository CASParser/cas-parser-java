...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CasParserNsdlParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CasParserNsdlParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(casParserNsdlParams: CasParserNsdlParams) = apply {
            body = casParserNsdlParams.body.toBuilder()
            additionalHeaders = casParserNsdlParams.additionalHeaders.toBuilder()
            additionalQueryParams = casParserNsdlParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CasParserNsdlParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CasParserNsdlParams =
            CasParserNsdlParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CasParserNsdlParams &&
            body == other.body &&
    ...
    override fun toString() =
        "CasParserNsdlParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
