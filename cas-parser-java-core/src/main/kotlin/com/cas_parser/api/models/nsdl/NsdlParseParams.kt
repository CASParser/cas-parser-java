...
package com.cas_parser.api.models.nsdl
...
/**
 * This endpoint specifically parses NSDL CAS (Consolidated Account Statement) PDF files and returns
 * data in a unified format. Use this endpoint when you know the PDF is from NSDL.
 */
class NsdlParseParams
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [NsdlParseParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [NsdlParseParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(nsdlParseParams: NsdlParseParams) = apply {
            body = nsdlParseParams.body.toBuilder()
            additionalHeaders = nsdlParseParams.additionalHeaders.toBuilder()
            additionalQueryParams = nsdlParseParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [NsdlParseParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): NsdlParseParams =
            NsdlParseParams(body.build(), additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NsdlParseParams &&
            body == other.body &&
    ...
    override fun toString() =
        "NsdlParseParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
