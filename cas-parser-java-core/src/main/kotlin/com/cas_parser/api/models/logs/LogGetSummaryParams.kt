...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [LogGetSummaryParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LogGetSummaryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(logGetSummaryParams: LogGetSummaryParams) = apply {
            body = logGetSummaryParams.body.toBuilder()
            additionalHeaders = logGetSummaryParams.additionalHeaders.toBuilder()
            additionalQueryParams = logGetSummaryParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LogGetSummaryParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LogGetSummaryParams =
            LogGetSummaryParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LogGetSummaryParams &&
            body == other.body &&
    ...
    override fun toString() =
        "LogGetSummaryParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
