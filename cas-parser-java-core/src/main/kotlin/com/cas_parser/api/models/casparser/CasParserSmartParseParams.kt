 ...
 * CAMS/KFintech and returns data in a unified format. It auto-detects the CAS type and transforms
 * the data into a consistent structure regardless of the source.
 */
class CasParserSmartParseParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CasParserSmartParseParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CasParserSmartParseParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(casParserSmartParseParams: CasParserSmartParseParams) = apply {
            body = casParserSmartParseParams.body.toBuilder()
            additionalHeaders = casParserSmartParseParams.additionalHeaders.toBuilder()
            additionalQueryParams = casParserSmartParseParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CasParserSmartParseParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CasParserSmartParseParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CasParserSmartParseParams &&
            body == other.body &&
    ...
    override fun toString() =
        "CasParserSmartParseParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
