...
private constructor(
    ...
    ) : this(msg, sessionId, status, mutableMapOf())
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [FetchRequestOtpResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FetchRequestOtpResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fetchRequestOtpResponse: FetchRequestOtpResponse) = apply {
            msg = fetchRequestOtpResponse.msg
            sessionId = fetchRequestOtpResponse.sessionId
            status = fetchRequestOtpResponse.status
            additionalProperties = fetchRequestOtpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FetchRequestOtpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FetchRequestOtpResponse =
            FetchRequestOtpResponse(msg, sessionId, status, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): FetchRequestOtpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FetchRequestOtpResponse &&
            msg == other.msg &&
    ...
    private val hashCode: Int by lazy { Objects.hash(msg, sessionId, status, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "FetchRequestOtpResponse{msg=$msg, sessionId=$sessionId, status=$status, additionalProperties=$additionalProperties}"
}
