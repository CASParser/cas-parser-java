...
package com.cas_parser.api.models.cdsl
...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): CdslParsePdfParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [CdslParsePdfParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CdslParsePdfParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(cdslParsePdfParams: CdslParsePdfParams) = apply {
            body = cdslParsePdfParams.body.toBuilder()
            additionalHeaders = cdslParsePdfParams.additionalHeaders.toBuilder()
            additionalQueryParams = cdslParsePdfParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CdslParsePdfParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CdslParsePdfParams =
            CdslParsePdfParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CdslParsePdfParams &&
            body == other.body &&
    ...
    override fun toString() =
        "CdslParsePdfParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
