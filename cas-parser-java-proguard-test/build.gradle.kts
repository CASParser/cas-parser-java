...
dependencies {
    testImplementation(project(":cas-parser-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../cas-parser-java-core/src/main/resources/META-INF/proguard/cas-parser-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.cas_parser.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../cas-parser-java-core/src/main/resources/META-INF/proguard/cas-parser-java-core.pro",
